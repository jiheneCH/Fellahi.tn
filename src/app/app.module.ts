...
import { TransporteurSideBarComponent } from './layouts/transporteur-side-bar/transporteur-side-bar.component';
import { HeaderTransporteurComponent } from './layouts/header-transporteur/header-transporteur.component';

import { DeliveriesClientComponent } from './FrontOffice/deliveries-client/deliveries-client.component';


import { NavCientComponent } from './FrontOffice/clientLayout/nav-cient/nav-cient.component';
import { ClientLayoutComponent } from './FrontOffice/clientLayout/client-layout/client-layout.component';
import { FooterClientComponent } from './FrontOffice/clientLayout/footer-client/footer-client.component';
...
@NgModule({
    ...
    declarations: [
        ...
        ProfTableComponent,
        TransporteurLayoutComponent,
        TransporteurSideBarComponent,
      
        HomeFrontComponent,
                DeliveriesClientComponent,
                NavCientComponent,
                ClientLayoutComponent,
                FooterClientComponent,
                HeaderTransporteurComponent
