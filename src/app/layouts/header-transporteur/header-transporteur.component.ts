...
@Component({
  selector: 'app-header-transporteur',
  templateUrl: './header-transporteur.component.html',
  styleUrls: ['./header-transporteur.component.css'],
   animations: [
...
export class HeaderTransporteurComponent {
 store: any;
    search = false;
    notifications = [
        {
