...
@Component({
  selector: 'app-transporteur-layout',
  templateUrl: './transporteur-layout.component.html',
  styleUrls: ['./transporteur-layout.component.css']
})
export class TransporteurLayoutComponent {
    store: any;
    showTopButton = false;
