...
import tn.esprit.fallehiuser.model.Recurrence;
import tn.esprit.fallehiuser.model.StatusEvent;

import tn.esprit.fallehiuser.model.TypeEvent;
import tn.esprit.fallehiuser.Repository.EventRepository;
import tn.esprit.fallehiuser.Services.IEventServices;
...
public class EventRestController {
   ...
   // public ResponseEntity<Map<String, String>> addEvent(@Valid @RequestBody Event event, BindingResult result) {
    ...
    public ResponseEntity<Map<String, String>> addEvent(
            ...
            @RequestParam("statusEvent") String statusEvent,
        ...
        try {
            ...
            event.setStatusEvent(StatusEvent.valueOf(statusEvent));
