...
public class LivraisonServiceImpl implements ILivraisonServices {
    ...
    public User findTransporteurAvecMoinsDeLivraisons(String delegation) {
        List<User> users = userRepository.findUserByRoleRoleNameAndGovernorate(TRANSPORTER,  delegation);
        if (users.isEmpty()) {
    ...
    public Map<String, Object> creerLivraison(Long idCommande) {
        ...
        User client = userRepository.findById(commande.getUser().getId())
        ...
        double prixTotalLivraison = calculerPrixTotalLivraison(delegationClient, commande.getPrixTotalCommande());
        ...
        response.put("commande", Map.of(
                ...
                "prix", commande.getPrixTotalCommande()
        ));
    ...
    public void signalerIncidentLivraison(Long idLivraison, String type, String description) {
        ...
        livraison.setStatut(StatutLivraison.PROBLEM);
    ...
    public Map<String, Long> calculerLivraisonsParStatut() {
        ...
        long livraisonsProblem = livraisonRepository.countByStatut(StatutLivraison.PROBLEM);
        ...
        result.put("Livraisons avec Problème", livraisonsProblem);
    ...
    public List<Livraison> findByTransporteurId(Long transporteurId) {
        return livraisonRepository.findByArchivedFalseAndTransporteur_Id(transporteurId);
    }
    @Override
    ...
    public Livraison reaffecterLivraison(Long livraisonId) {
        ...
        String delegationClient = livraison.getCommande().getUser().getGovernorate();
    ...
    public String getAdresseFromCommande(Long commandeId) {
        ...
        return commande.getUser().getAddress();
    }
    ...
    public Map<String, Long> calculerStatusParLivreur( long idLivreur)
{
    ...
    long livraisonsProblem = livraisonRepository.countByStatutAndTransporteur_Id(StatutLivraison.PROBLEM, idLivreur);
    // Créer une map de résultats à retourner
    Map<String, Long> result = new HashMap<>();
    result.put("Livraisons Livrées", livraisonsLivrees);
    result.put("Livraisons Annulées", livraisonsAnnulees);
    ...
    public Map<String, Long> findByStatutEtDelegation(String delegation)
{
    ...
    long livraisonsProblem = livraisonRepository.countByStatutAndClient_Governorate(StatutLivraison.PROBLEM, delegation);
    // Créer une map de résultats à retourner
    Map<String, Long> result = new HashMap<>();
    result.put("Livraisons Livrées", livraisonsLivrees);
    result.put("Livraisons Annulées", livraisonsAnnulees);
