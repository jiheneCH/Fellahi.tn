...
/*
   ...
   /* public List<Livraison> getLivraisonsTransporteur() {
    ...
    public int getPointFidelityClient() {
        return pointFidelityClient;
    }

    public void setPointFidelityClient(int pointFidelityClient) {
        this.pointFidelityClient = pointFidelityClient;
    }
